...
import SucessButton from "@/Components/Button/SucessButton";
                ...
                <div className="overflow-hidden bg-white shadow-lg sm:rounded-lg dark:bg-gray-200">
                    <div className="flex justify-between items-center m-4">
                        ...
                        <div className="flex space-x-4">
                            <Link href={route("users.create")}>
                                <SucessButton>Cadastrar</SucessButton>
                            </Link>
                        </div>
                    </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead className="bg-gray-50 dark:bg-gray-200">
                            <tr>
                                <td className="px-6 py-3 text-left text-sm font-medium text-gray-00 tracking-wider">
                                    ID
                                </td>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-200 dark:divide-gray-700">
                            {users.data.map((user) => (
                                <tr
                                    key={user.id}
